...
files = os.listdir('../runs/fastggm/output')
auroc = []
average_precision = []
for _filename in files:
    ...
    pred = pandas.read_csv(filename, sep=' ', index_col=0, usecols=range(2*ngenes, 3*ngenes))
    ...
    fig.savefig('fastggm/'+_filename.split('-')[0]+'_roc.png')
